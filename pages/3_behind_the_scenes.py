...
st.markdown('''
                ...
                To solve the challenging task of predicting art styles, we used the **deep learning (DL)** method, in which **convolutional neural networks (CNNs)** are built to analyse large datasets.
